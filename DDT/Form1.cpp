...
void Form1::button2_Click(System::Object^  sender, System::EventArgs^  e)
{
	...
	GetAddress("\x8B\x45\xFF\x89\x48\xFF\xFF\xFF\x00\xFF\x8B\xEC\xFF\xFF\xFF\xFF\xFF\xFF\x8B\x40\xFF\x83\xEC\xFF\x50", "xx?xx???x?xx??????xx?xx?x");
...
void Form1::button3_Click(System::Object^  sender, System::EventArgs^  e)
{
	...
	GetAddress("\x39\x00\x89\x48\xFF\x8B\x47\xFF\x85\xFF\x7D\xFF", "xxxx?xx?x?x?");
